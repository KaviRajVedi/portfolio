        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <Link to="/" className="flex items-center">
              <span className="text-xl font-bold text-gray-800">Kavi Raj Vedi</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/projects" className="text-gray-700 hover:text-blue-600 px-3 py-2">Projects</Link>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link to="/projects" className="block text-gray-700 hover:text-blue-600 px-3 py-2">Projects</Link>
